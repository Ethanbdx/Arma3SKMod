...
if((count(weapons killer1)<=_wc) AND alive killer1) then {_marker setmarkercolorlocal "ColorGreen";};
};
...
if((count(weapons killer2)<=_wc) AND alive killer2) then {_marker setmarkercolorlocal "ColorGreen";};
};
sleep 5;
